...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '2eb012f3d4a981c2947ed8d6138bf227',
  THEME: process.env.NEXT_PUBLIC_THEME || 'matery_custom', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2016, // e.g if leave this empty, current year will be used.
  ...
  BACKGROUND_LIGHT: process.env.NEXT_PUBLIC_BACKGROUND_LIGHT || '#0e1116', // 日间模式背景色（深色背景）
  BACKGROUND_DARK: process.env.NEXT_PUBLIC_BACKGROUND_DARK || '#0a0a0a', // 深色模式背景色

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HJ', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个视觉设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.haoping.me/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人网站, 作品集', // 网站关键词 英文逗号隔开
